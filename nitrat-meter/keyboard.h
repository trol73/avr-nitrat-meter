...
unsigned char knopka (void)
{
	...
	unsigned char kn=0;                    //Переменная признака наж.кн.
	...
	{ if (p==0b00001110) kn=3;             //Если нажата кнопка ВВЕРХ
		else if (p==0b00001011) kn=4;        //Если нажата кнопка ВНИЗ
		else if (p==0b00000111) kn=5;        //Если нажата кнопка ВЛЕВО
		else if (p==0b00001101) kn=6;        //Если нажата кнопка ВПРАВО
		else if (p!=0b00001111) kn=7;        //Если нажаты одновременно несколько кнопок (ВВЕРХ, ВНИЗ, ВЛЕВО, ВПРАВО)
		else if (p==0b00001111) kn=0;        //Если все кнопки отжаты - kn=0
	}
	return(kn);
}
//
