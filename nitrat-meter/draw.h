...
//
  ...
  else if (menu_cnt==0) menu_nach();     //Вывод начального меню
  else if (menu_cnt==1) menu_prod();     //Вывод меню выбора продукта
  else if (menu_cnt==2) menu_izm();      //Вывод меню измерения
  else if (menu_cnt==3) menu_nastr();    //Вывод меню настроек
  else if (menu_cnt==4) menu_PDK();      //Вывод меню норм ПДК
